...
var array7 = [6, 7, 8, 9];
var array8 = array6.concat(array7);
console.log(array8);

console.log("---------------------------------------------------");
console.log(`JOIN   Array`);
var result1 = array8.join("!");
console.log(result1);
console.log("---------------------lop   no  reverse in  this    method------------------------------");
...
console.log(array8);
console.log("---------------------------------------------------");
console.log(`SPREAD  OPERATOR   Array(use   for clonning    purpose)`);
